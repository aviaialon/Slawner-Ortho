<form class="mainForm" id="AddMenuForm" method="post" action="<?php echo $arrRequestParams['View_Data']['Save_User_Url']; ?>">
	<input type="hidden" name="menu_type" value="new" />
	<fieldset>
		<div class="widget gbox_margin_top0">
			<div class="head">
				<h5 class="iList">Add a New Menu</strong></h5>
            ...
            <div class="rowElem nobg">
            	...
            	<div class="formBottom">
            		<input type="text" name="title" id="add-menu-title" value="" original-title="Menu Title">
            	</div>
            	<div class="fix"></div>
            </div>
            <div class="rowElem">
            	...
            	<div class="formBottom">
            		<input type="text" name="url" id="add-menu-url" value=""  original-title="Menu URL">
            	</div>
            	<div class="fix"></div>
            </div>
            <div class="rowElem">
            	...
            	<div class="formBottom">
            		<input type="text" name="class" id="add-menu-class" value="" original-title="Menu CSS Class">
            	</div>
            	<div class="fix"></div>
            </div>
            <!--
