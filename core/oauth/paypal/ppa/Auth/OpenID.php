...
class Auth_OpenID {
    ...
    static function autoSubmitHTML($form, $title="OpenId transaction in progress", $strFormId = NULL)
    {
        return("<html>".
               "<head><title>".
               $title .
               "</title></head>". 
               "<body onload='" . ((bool) $strFormId ? "document.getElementById('" . $strFormId . "').submit()" : "document.forms[0].submit();") . "'>".
               $form .
               "<script>".
