/**
 * Website: http://sourceforge.net/projects/simplehtmldom/ || Manual available in: http://simplehtmldom.sourceforge.net/manual.htm
...
{
	public static final function getInstanceFromUrl($strUrl)	
	{
		return file_get_html($strUrl);
	}
	
	public static final function getInstanceFromHtml($strHTML)	
	{
		return str_get_html($strHTML);
	}
}
