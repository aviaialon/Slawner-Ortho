...
(function(b) {
	...
	a.prototype = {
		...
		buildColorPicker: function(l, k) {
			var f;
			if (k === "backcolor") {
				if ((! typeof b.browser == "undefined") && (! typeof b.browser.msie == "undefined") && (b.browser.msie)) {
					f = "BackColor"
				} else {
					f = "hilitecolor"
				}
