...
(function ($) {
	$.fn.daterangepicker = function(settings, objApplicationInstance){
		var rangeInput = $(this);

		//defaults
		var options = $.extend({
			presetRanges: [
				{text: objApplicationInstance.translate('Today', 'Aujourd\'hui'), dateStart: 'today', dateEnd: 'today' },
				{text: objApplicationInstance.translate('Tomorrow', 'Demain'), dateStart: 'Tomorrow', dateEnd: 'Tomorrow' },
				{text: objApplicationInstance.translate('This Week', 'Cette Semaine'), dateStart: 'today', dateEnd: 'today+7days' },
				{text: objApplicationInstance.translate('Within 2 Weeks', 'Dans deux semaines'), dateStart: 'today', dateEnd: 'today+14days' },
				//{text: objApplicationInstance.translate('This Month', 'Ce mois-ci'), dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
				{text: objApplicationInstance.translate('Within a Month', 'Dans un mois'), dateStart: 'today', dateEnd: 'Today+30' },
		...
		target: rangeInput,
		doneButtonText: 'Done',
		earliestDate: Date.parse('today'),//Date.parse('-15years'), //earliest date allowed 
		latestDate: Date.parse('+5years'), //latest date allowed 
	...
	var datepickerOptions = {
		...
		var doneBtn = $('<button class="btnDone ui-state-default ui-corner-all button small dark_blue">'+ options.doneButtonText +'</button>')
		.click(function(){
