...
<footer>
	<div class="row">
		...
		<div class="three columns mobile-two">
			<ul class="footer-list-address">
				<li>
					<p><span class="bold"><?php echo($this->Application->translate('Headquarters', 'Siège social')); ?>:</span><br /></p>
		...
		<div class="three columns">
			<div class="copyright">
				...
				<p>&copy; Copyright <?php echo(date('Y') . ' ' . constant('__SITE_NAME__')); ?><br/>All Rights Reserved</p>
			</div>
		</div>	
	</div>
	...
	<div class="lang-selector-view"> 
		<a class="select">
			<span><img src="<?php echo($this->strApplicationStaticResPath); ?>images/selector/<?php echo($this->Application->translate('us', 'ca')); ?>_small.png" width="18" height="14"  /> 
		...
		<div class="popover">
			...
			<ul>
				<li><a href="<?php echo($this->Application->getEnglishCanonicalUrl()); ?>"<?php echo($this->Application->translate(' class="selected"', '')); ?>>
					<img src="<?php echo($this->strApplicationStaticResPath); ?>images/selector/us_big.png" width="34" height="25" /> <span>English</span></a></li>
